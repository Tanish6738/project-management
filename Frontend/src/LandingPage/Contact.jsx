            ...
            <div className="bg-white rounded-xl shadow-xl p-8 border border-slate-100">
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-center">
                  <input type="checkbox" id="privacy" className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-slate-300 rounded" />
                  <label htmlFor="privacy" className="ml-2 block text-sm text-slate-600">
                    I agree to the <a href="#" className="text-indigo-600 hover:text-indigo-800">Privacy Policy</a> and <a href="#" className="text-indigo-600 hover:text-indigo-800">Terms of Service</a>
                  </label>
                </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-slate-900 mb-1">Phone</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-slate-900 mb-1">Email</h4>
                      <p className="text-slate-600">support@projectflow.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-slate-900 mb-1">Office</h4>
                      <p className="text-slate-600">123 Innovation Drive<br />San Francisco, CA 94103</p>
                    </div>
                  </div>
                </div>
              </div>
