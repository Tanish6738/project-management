      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-16">
          <div className="col-span-2">
            <div className="mb-6">
              <h2 className="text-2xl font-bold tracking-tight text-white">ProjectFlow</h2>
              <p className="text-white/70 mt-2 text-sm">
                Empower your team with realtime project management that drives results.
              </p>
            </div>
          ...
          {footerLinks.map((column, idx) => (
            <div key={idx}>
              <h3 className="text-sm font-semibold uppercase tracking-wider mb-4 text-white">{column.title}</h3>
